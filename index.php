...
The CSS Zen Garden invites you to relax and meditate on the important lessons of the masters. Begin to see with clarity. Learn to use the time-honored techniques in new and invigorating fashion. Become one with the web. Littering a dark and dreary road lay the past relics of browser-specific tags, incompatible DOMs, broken CSS support, and abandoned browsers.
...
<h1>Moments forts</h1>
<video src="" controls poster="img.png" width="600" style="margin:auto;display:flex"></video>
<?php
	include 'templates/slider2.php';
?>
</section>
</div>
<?php
